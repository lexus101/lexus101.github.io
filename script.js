...
// Give the hero title a very light per-character wave. The heading already has
// an aria-label, so these spans are presentation-only.
document.querySelectorAll('.hero-line').forEach((line) => {
  if (!line.classList.contains('agency-word')) {
  ...
  [...line.children].forEach((char, index) => {
    char.classList.add('hero-char');
